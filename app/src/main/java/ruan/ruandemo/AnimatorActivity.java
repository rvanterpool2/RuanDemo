...
public class AnimatorActivity extends BaseActivity {
    ...
    public void rotation(){
        ObjectAnimator animator = ObjectAnimator.ofFloat(tv,"rotation",0,3800,0);//rotationX   rotationY
        animator.setDuration(2000);
        animator.start();
    }
    ...
    private ValueAnimator doAnimatorListener(){
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                UtilLog.logD("Ruan","animation start");
            }

            @Override
            public void onAnimationEnd(Animator animation) {
                UtilLog.logD("Ruan","animation end");
            }

            @Override
            public void onAnimationCancel(Animator animation) {
                UtilLog.logD("Ruan","animation cancel");
            }

            @Override
            public void onAnimationRepeat(Animator animation) {
                UtilLog.logD("Ruan","animation repeat");
            }
        });
